...
public class Env {
	...
	public static final String MODACLOUDS_TOWER4CLOUDS_METHOD_NAME = "MODACLOUDS_TOWER4CLOUDS_METHOD_NAME";
	public static final String MODACLOUDS_TOWER4CLOUDS_METHOD_ID = "MODACLOUDS_TOWER4CLOUDS_METHOD_ID";	
